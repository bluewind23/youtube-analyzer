...
# 복잡한 관리자 URL 생성
ADMIN_SECRET_PATH = os.environ.get('ADMIN_SECRET_PATH', 'a7b9f3e2d8c1x4m6n9p2q5r8t1v4w7z0')
admin_routes = Blueprint('admin_routes', __name__, url_prefix=f'/sys-mgmt-{ADMIN_SECRET_PATH}')
